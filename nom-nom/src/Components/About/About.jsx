...
Welcome to PlatePal, your go-to place for delicious food! Our mission is to provide
the best dining experience with a variety of mouth-watering dishes that cater to
every taste.
</p>
<p className="text-lg text-gray-700 mb-4 transition-transform duration-300 transform hover:scale-105 hover:opacity-90">
At PlatePal, we believe in using fresh, high-quality ingredients to create dishes
...
Thank you for choosing PlatePal. We look forward to serving you!
</p>
</div>
</div>
);
